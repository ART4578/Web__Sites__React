import "./WalletSgrInputs.scss";

export default function WalletSgrInputs() {
    return (
        //inputs
        <div className="inp__sel">
            <div className="inps__divs__one">
                ...
                <div className="divs__inps__two">
                    <select name="wallet__sgr__sel" id="wallet__sgr__sel" className="wallet__sgr__sel">
