...
import QuickLinksData from "../../assets/data/quickLinksData";
                    ...
                    <Col lg="12">
                        ...
                        <div className="footer__bottom">
                            <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                                <i className="ri-copyright-line"></i> Copyright {year}, Developed by <span style={{ color : "#f9a826" }}>Arthur Petrosyan.</span> All rights reserved. 
                            </p>  
                            <div className="arrow__top">
                                <i class="ri-arrow-up-line arrow__top__btn" onClick={scrollTop}></i>   
                            </div>                                   
                        </div>            
                    </Col>
                </Row>
